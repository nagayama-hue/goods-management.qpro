...
export default function SalesNewForm({ goods, events, action }: Props) {
  ...
  function handleColorChange(color: string) {
    ...
    if (first) {
      ...
      setSellingPrice(first.sellingPrice ?? goods.sales.sellingPrice);
  ...
  function handleVariantChange(variantId: string) {
    ...
    if (v) {
      setSellingPrice(v.sellingPrice ?? goods.sales.sellingPrice);
